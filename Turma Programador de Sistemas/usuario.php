          ...
          <div class="col-md cartao">
                    ...
                    <form action="<?= $destino; ?>" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input name="senha" value="<?php echo isset($usuarios) ? $usuarios['senha'] : "" ?>"
                          type="password" class="form-control" placeholder="Insira sua senha">
                      </div>
            ...
            <table id="tabela" class="table table-striped table-hover">
              ...
              <tbody>
                ...
                <?php
                //Selecione todos os usuarios do banco de dados
                ...
                while($linha = mysqli_fetch_assoc($dados)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="m-3" href="usuario.php?codigo=<?= $linha['id']; ?>"><i
                          class="bi bi-pencil-square"></i></a>
                      <a href="<?php echo "./usuario/excluir.php?id=".$linha['id'] ?>"><i class="bi bi-trash"></i></a>
                    </td>
